**Les taules han estat processades abans de la seva importació a la base de dades (PostgreSQL)

--CREACIÓ DE LES COLUMNES AMB LES DADES DE NAIXEMENTS, DEFUNCIONS, POBLACIÓ I CREIXEMEN VEGETATIU
...
ALTER TABLE catalunya.limits_comarcals ADD COLUMN poblacio_2023_percentatge DOUBLE PRECISION;


--INSERCIÓ DE LES DADES EN LES NOVES COLUMNES, A PARTIR DEL NOM DE COMARCA
...
--CÀLCUL DEL CREIXEMENT VEGETATIU PER CADA 1000 HABITANTS (A PARTIR DE LA FÓRMULA EMPRADA PER L'INE, Instituto Nacional de Estadística)
